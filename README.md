# GitHub with CLion
We will be using GitHub for all of the Guided Projects, Open-Ended Projects, and the Final Project this semester. You should bookmark the organization page on your preferred web browser: [https://github.com/uvmcs120s2022](https://github.com/uvmcs120s2022)
...
* From the Guided Project GitHub page, click the green "Use this template" button.
    * Alternatively, from the organization page ([https://github.com/uvmcs120s2022](https://github.com/uvmcs120s2022)), click the green "New" button and choose the appropriate Guided Project from the "Repository template" dropdown.
...
* Go to the organization page on GitHub: [https://github.com/uvmcs120s2022](https://github.com/uvmcs120s2022)
